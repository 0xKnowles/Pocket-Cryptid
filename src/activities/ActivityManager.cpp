...
void ActivityManager::goHome() { replaceActivity(std::make_unique<DashboardActivity>(renderer, mappedInput)); }
...
bool ActivityManager::isHomeActivity() const { return currentActivity && currentActivity->name == "Dashboard"; }
