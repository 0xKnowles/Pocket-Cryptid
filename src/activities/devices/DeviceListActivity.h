...
//
// To add a network to the active-deauth whitelist/blacklist, use Settings' "Whitelist"/
// "Blacklist" rows (TargetPickerActivity) — a dedicated live network scan, not this screen.
